        ...
        <div style={styles.headerRow}>
          <div>
            ...
            <p style={styles.pageSubtitle}>
              Track deal progress, view underwriting outcomes, and see final
              controller decisions in one place.
            </p>
          </div>
...
function StatusNotice({ status }: { status: string }) {
  ...
  if (status === "APPROVED") {
    return (
      <div style={{ ...styles.noticeBox, ...styles.noticeSuccess }}>
        Deal approved. Review lender, tier, max payment, and next funding steps.
      </div>
    )
  }
