  ...
  return (
    <main className="min-h-screen overflow-hidden bg-[#f7f4ee] text-[#111111]">
      ...
      <div className="pointer-events-none fixed inset-0 overflow-hidden">
        <div className="absolute inset-0 bg-[linear-gradient(180deg,#fbf9f5_0%,#f6f2eb_42%,#f2eee7_100%)]" />
        <div className="absolute left-[-10%] top-[-6%] h-[520px] w-[520px] rounded-full bg-white/90 blur-3xl" />
        <div className="absolute left-[18%] top-[14%] h-[500px] w-[500px] rounded-full bg-[#efe5d7] blur-3xl opacity-70" />
        <div className="absolute right-[-8%] top-[8%] h-[420px] w-[420px] rounded-full bg-white/80 blur-3xl" />
        <div className="absolute inset-0 opacity-[0.05] [background-image:linear-gradient(rgba(17,17,17,0.18)_1px,transparent_1px),linear-gradient(90deg,rgba(17,17,17,0.18)_1px,transparent_1px)] [background-size:84px_84px]" />
      ...
      <section className="relative z-10">
        <div className="mx-auto grid max-w-7xl grid-cols-1 gap-16 px-8 pb-20 pt-8 lg:grid-cols-[1.08fr_0.92fr] lg:pt-10">
          <div className="max-w-4xl">
            ...
            <h1 className="max-w-5xl text-[72px] font-semibold leading-[0.88] tracking-[-0.08em] text-[#111111] sm:text-[92px] xl:text-[118px]">
              Underwriting.
              <br />
              Elevated.
            </h1>

            <p className="mt-8 max-w-2xl text-[24px] leading-[1.45] tracking-[-0.02em] text-black/62">
              Luxury-grade decision infrastructure for modern auto finance.
              Evaluate cleaner, route smarter, and move with the confidence of a
              platform built to command attention.
            </p>
            ...
            <div className="relative overflow-hidden rounded-[40px] border border-black/8 bg-white/78 p-7 shadow-[0_35px_90px_rgba(0,0,0,0.10)] backdrop-blur-xl">
              ...
              <div className="mt-5 rounded-[30px] border border-black/8 bg-[#fcfbf8] p-6">
                ...
                <p className="text-[19px] leading-8 tracking-[-0.02em] text-black/64">
                  ...
                  down position create a clean approval path with strong lender
                  alignment and low-friction execution.
                </p>
              </div>
              ...
              <div className="mt-5 grid grid-cols-3 gap-3">
                ...
                <div className="rounded-[24px] border border-black/8 bg-white p-5 text-center shadow-[0_10px_24px_rgba(0,0,0,0.03)]">
                  ...
                  <div className="mt-3 text-[18px] font-semibold">Direct</div>
                </div>
                ...
                <div className="rounded-[24px] border border-black/8 bg-white p-5 text-center shadow-[0_10px_24px_rgba(0,0,0,0.03)]">
                  ...
                  <div className="mt-3 text-[18px] font-semibold">Prime</div>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="mx-auto grid max-w-7xl grid-cols-1 gap-6 px-8 md:grid-cols-3">
          <div className="rounded-[32px] border border-black/8 bg-white/72 p-8 shadow-[0_18px_45px_rgba(0,0,0,0.05)]">
            ...
            <p className="mt-4 text-[17px] leading-8 text-black/60">
              Evaluate score, structure, cash position, and lender fit in a
              cleaner decision flow designed for real operational speed.
            </p>
          </div>
          ...
          <div className="rounded-[32px] border border-black/8 bg-white/72 p-8 shadow-[0_18px_45px_rgba(0,0,0,0.05)]">
            ...
            <p className="mt-4 text-[17px] leading-8 text-black/60">
              Move from intake to underwriting to outcome with a platform layer
              that feels polished, readable, and in complete control.
            </p>
          </div>
          ...
          <div className="rounded-[32px] border border-black/8 bg-white/72 p-8 shadow-[0_18px_45px_rgba(0,0,0,0.05)]">
            ...
            <p className="mt-4 text-[17px] leading-8 text-black/60">
              Give your stores an operating experience that feels premium,
              decisive, and built for high-trust execution.
            </p>
          </div>
        </div>
      </section>
