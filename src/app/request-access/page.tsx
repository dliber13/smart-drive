    ...
    <main className="min-h-screen bg-[#f7f3ec] px-6 py-10 text-[#111111]">
      <div className="mx-auto max-w-5xl">
        ...
        <section className="mt-10 rounded-[2rem] border border-neutral-200 bg-white p-8 shadow-sm md:p-14">
          ...
          <form onSubmit={handleSubmit} autoComplete="off" className="mt-12 grid gap-8 md:grid-cols-2">
            <label className="block">
              <span className="mb-3 block tracking-[0.35em] text-xs font-semibold text-neutral-400">FIRST NAME *</span>
              <input name="firstName" value={formData.firstName} onChange={handleChange} required autoComplete="off" className="w-full rounded-[1.5rem] border border-neutral-200 px-5 py-4 outline-none" placeholder="Doug" />
            </label>
            <label className="block">
              <span className="mb-3 block tracking-[0.35em] text-xs font-semibold text-neutral-400">LAST NAME *</span>
              <input name="lastName" value={formData.lastName} onChange={handleChange} required autoComplete="off" className="w-full rounded-[1.5rem] border border-neutral-200 px-5 py-4 outline-none" placeholder="Liber" />
            </label>
            <label className="block">
              <span className="mb-3 block tracking-[0.35em] text-xs font-semibold text-neutral-400">DEALERSHIP NAME *</span>
              <input name="dealerName" value={formData.dealerName} onChange={handleChange} required autoComplete="off" className="w-full rounded-[1.5rem] border border-neutral-200 px-5 py-4 outline-none" placeholder="Good Autos" />
            </label>
            <label className="block">
              <span className="mb-3 block tracking-[0.35em] text-xs font-semibold text-neutral-400">TITLE</span>
              <input name="title" value={formData.title} onChange={handleChange} autoComplete="off" className="w-full rounded-[1.5rem] border border-neutral-200 px-5 py-4 outline-none" placeholder="Finance Manager" />
            </label>
            <label className="block">
              <span className="mb-3 block tracking-[0.35em] text-xs font-semibold text-neutral-400">EMAIL *</span>
              <input name="email" type="email" value={formData.email} onChange={handleChange} required autoComplete="off" className="w-full rounded-[1.5rem] border border-neutral-200 px-5 py-4 outline-none" placeholder="you@dealership.com" />
            </label>
            <label className="block">
              <span className="mb-3 block tracking-[0.35em] text-xs font-semibold text-neutral-400">PHONE</span>
              <input name="phone" type="tel" value={formData.phone} onChange={handleChange} autoComplete="off" className="w-full rounded-[1.5rem] border border-neutral-200 px-5 py-4 outline-none" placeholder="816-555-0100" />
            </label>
            <label className="block">
              <span className="mb-3 block tracking-[0.35em] text-xs font-semibold text-neutral-400">CITY</span>
              <input name="city" value={formData.city} onChange={handleChange} autoComplete="off" className="w-full rounded-[1.5rem] border border-neutral-200 px-5 py-4 outline-none" placeholder="Kansas City" />
            </label>
            <label className="block">
              <span className="mb-3 block tracking-[0.35em] text-xs font-semibold text-neutral-400">STATE</span>
              <select name="state" value={formData.state} onChange={handleChange} autoComplete="off" className="w-full rounded-[1.5rem] border border-neutral-200 px-5 py-4 outline-none bg-white">
            ...
            <label className="block md:col-span-2">
              ...
              <select name="monthlyUnits" value={formData.monthlyUnits} onChange={handleChange} autoComplete="off" className="w-full rounded-[1.5rem] border border-neutral-200 px-5 py-4 outline-none bg-white">
            ...
            <label className="block md:col-span-2">
              ...
              <textarea name="message" value={formData.message} onChange={handleChange} rows={5} autoComplete="off" className="w-full rounded-[1.5rem] border border-neutral-200 px-5 py-4 outline-none" placeholder="Tell us about your current finance process..." />
            </label>
            {error && (
